...
include_once 'dbConnection.php';
echo ' <a href="account.php?q=1" class="log log1"><span class="glyphicon glyphicon-user"></span>'.$name.'</a>';
}?>
    </li>

    <li> <a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span></li>
    </ul>
  </div>
</nav>
<div class="bg">
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>Quizzle</b></a>
    </div>
